  ...
  tabsetPanel(
    ...
    tabPanel("Trends and statistics",
             ...
             fluidRow(column(width = 7, plotOutput("main_plot", height = 450),
                      ...
                      bsTooltip("non_life_exp_no_labels", "While most variables are measured in units of percentage, life expectancy variables are measured in units of years and median income in $USD. All values range between 0 and 100, with $USD being in thousands (K) to fit on 0-100 scale.", "top"),
             )
    )
    ,
    ## (3) Heatmaps-----
