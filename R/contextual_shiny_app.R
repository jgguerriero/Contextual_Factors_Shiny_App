...
# load state data
# raw_state_data = read.csv("/Users/jgg5264/Library/CloudStorage/OneDrive-ThePennsylvaniaStateUniversity/SoDA RA/deployment/merged_st_data_w_race_occ_2023_03_14")
raw_state_data = read.csv("./merged_st_data_w_race_occ_2023_03_28.csv")

# load county data
# raw_county_data = read.csv("/Users/jgg5264/Library/CloudStorage/OneDrive-ThePennsylvaniaStateUniversity/SoDA RA/deployment/merged_cnty_data_w_race_occ_2023_03_14")
raw_county_data = read.csv("./merged_cnty_data_w_race_occ_2023_03_28.csv")
...
ui = fluidPage(
  ...
  fluidRow(
    column(
      width = 6,
      titlePanel(h1("The Contextual Factors Project"), windowTitle = "The Contextual Factors Project")
    ),
    column(
      width = 6,
      div(
  ...
  tabsetPanel(
    ...
    tabPanel(
      ...
      tags$div(
        ...
        HTML(paste0('<div style="text-align: center; font-size: 25px; font-family: Arial;">Welcome to the data dashboard 
             ...
             about the dataset, you may find it helpful to download and reference <a href="contextual_factors_codebook.pdf" download="contextual_factors_codebook.pdf"> this codebook </a>.</div>'))
      )
    ),
    ## (1) Data info-----
    tabPanel("Data info & availability",
             fluidRow(
               ...
               column(3, tags$div(pickerInput("variable1", label = h4("Variables available for comparison"), 
                                     ...
                                     class = "my-picker")),
               column(1, radioButtons("level1", label = h4("Level of analysis"), 
    ...
    tabPanel("Heatmaps",
             ...
             conditionalPanel(
               ...
               column(3, HTML("Extreme values were fixed to the upper or lower thresholds of <a href='https://aakinshin.net/posts/tukey-outlier-probability/'>Tukey's Fences</a> to create additional color contrast. 
...
server <- function(input, output) {
  ...
  output$availability_plot <- renderPlot({
    ...
    level_of_analysis_key = list("State" = "st_", "County" = "cnty_", 
                              "State_color" = "blue3", "County_color" = "green4",
    ...
    # variable_based_on_comparison = "st_sex_ratio_males_e0"
